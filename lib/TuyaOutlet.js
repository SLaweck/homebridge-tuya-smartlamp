...
class TuyaOutlet extends TuyaAccessory {
    ...
    getDeviceService() {
        ...
        if (this.isMonitoring) {
            ...
            deviceService.addOptionalCharacteristic(Eve.Characteristic.Voltage);
            deviceService.addOptionalCharacteristic(Eve.Characteristic.ElectricCurrent);
            deviceService.addOptionalCharacteristic(Eve.Characteristic.CurrentConsumption);
            const voltageCharacteristic = deviceService.getCharacteristic(Eve.Characteristic.Voltage)
                .on('get', this.getVoltage.bind(this));
            const currentCharacteristic = deviceService.getCharacteristic(Eve.Characteristic.ElectricCurrent)
                .on('get', this.getCurrent.bind(this));
            const consumptionCharacteristic = deviceService.getCharacteristic(Eve.Characteristic.CurrentConsumption)
            ...
            if (this.interval) {
                ...
                deviceService.addOptionalCharacteristic(Eve.Characteristic.TotalConsumption);
                const totalConsumptionCharacteristic = deviceService.getCharacteristic(Eve.Characteristic.TotalConsumption)
                ...
                historyService.addOptionalCharacteristic(Eve.Characteristic.ResetTotal);
                const resetTotalCharacteristic = historyService.getCharacteristic(Eve.Characteristic.ResetTotal)
